...
import Inputs from "./inputcreate";
import FieldComponent from "./fieldcomponentcreate";
import Banner from "../../components/RepeatableComponent/Banner";
import FormWrapper from "../../components/RepeatableComponent/FormWrapper";
import { languageNativeNames } from "../i18n";

import {
  connect,
  select,
} from "../../components/RepeatableComponent/DraggedItem/utils";
                  ...
                  <div className="row" key={key}>
                    {fieldRow.map(
                      ({ name, fieldSchema, metadatas, queryInfos, size }) => {
                        ...
                        newMetadatas.label = `${newMetadatas.label} (${languageNativeNames[locale]})`;
                        if (isComponent) {
